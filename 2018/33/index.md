...
On the subject of head breaking, librarians Anya, Jayne and Claire; Michaels Mike and Michael; some highlighter pens; and much paper met to check the [procedure data](https://procedures.azurewebsites.net/) they've entered matches the current state of the flowcharts. They had hoped to cover all five procedures but limped along to the end of one. An exhausted Mike crept from the room and decided that writing a screen's worth of SQL would save everyone's sanity here. More checking is planned but Mike's work will hopefully make fewer brains break.
...
### Use APIs, they said. What could wrong, they asked?
...
Noel continued his work to clear all the tickets that were logged during the last couple of weeks' performance issues. He's used the tickets to form a bench test to check that the system is in the same state it was in prior to the fault. All the tests have proved satisfactory, faults are being addressed and no new reported or observable problems have come to his attention. Work continues around improving the system and avoiding any reoccurrence. Fire extinguishers are on order.
