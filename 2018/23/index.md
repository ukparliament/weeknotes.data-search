...
Anya and Michael went to Brighton to meet [Silver](https://twitter.com/silveroliver). Because he lives there. Or near there. And because it's the seaside. And because it has dodgems and air hockey. They [sat on the beach](https://twitter.com/fantasticlife/status/1004691294315274240) and planned out a talk they're due to give to [NetIKX](http://www.netikx.org/). Which was supposed to be an introduction to ontologies for librarians and knowledge management people, but has ended up as plea to switch from learning ontologies to learning about [domain modelling](https://en.wikipedia.org/wiki/Domain-driven_design) instead. So no one gets their money's worth there.
...
No strolls were reported this week. Though Anya, Silver and Michael did walk to the end of Brighton pier. Well, as far as the [dodgems](https://twitter.com/bitten_/status/1004722028719562752) anyway. Anya and Michael played air hockey. Anya whipped Michael's ass.
